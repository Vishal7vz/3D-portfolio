...
=======
  ...
  return (
    <section id="hero" className="relative flex min-h-[90vh] items-center overflow-hidden">
      <div className="pointer-events-none absolute inset-0 -z-10 opacity-70 [mask-image:radial-gradient(60%_60%_at_50%_40%,black,transparent)]">
        {/* Optional 3D scene URL can be replaced with your Spline URL */}
      ...
      <motion.div
        aria-hidden
        className="absolute left-[8%] top-10 -z-10 origin-top"
        initial={{ rotate: -8, y: 0 }}
        animate={{ rotate: [ -8, 8, -8 ], y: [0, 6, 0] }}
        transition={{ duration: 4.5, repeat: Infinity, ease: "easeInOut" }}
      >
        <div className="mx-auto h-16 w-px bg-white/60" />
        <Image src="/spidey.svg" alt="spidey" width={80} height={120} className="drop-shadow" />
      </motion.div>
      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col items-center px-4 pt-24 text-center md:flex-row md:items-center md:gap-10 md:text-left">
        ...
        <motion.span
          ...
          className="rounded-full border border-white/20 bg-white/60 px-3 py-1 text-xs text-zinc-700 backdrop-blur dark:border-white/10 dark:bg-zinc-900/60 dark:text-zinc-200"
        >
        ...
        <motion.p
          ...
          className="mt-4 max-w-2xl text-balance text-lg text-zinc-700 dark:text-zinc-300"
        >
          I build beautiful, modern web experiences with Next.js, TypeScript, and 3D/animated interactions.
        </motion.p>
        ...
        <motion.div
          ...
          className="mt-3 inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/60 px-3 py-1 text-xs text-zinc-800 backdrop-blur dark:border-white/10 dark:bg-zinc-900/60 dark:text-zinc-100"
        >
        ...
        <motion.div
          ...
          className="order-1 md:order-2 md:flex-1 md:justify-end"
        >
          <div
            ref={avatarRef}
            onMouseMove={handleMove}
            onMouseLeave={handleLeave}
            className="relative mx-auto h-56 w-40 rounded-3xl md:h-80 md:w-56"
            style={{
          ...
          >
            ...
            <div className="relative h-full w-full overflow-hidden rounded-3xl border border-white/20 bg-white/50 shadow-xl backdrop-blur dark:border-white/10 dark:bg-zinc-900/60">
              ...
              <div
                ...
                style={{
                  background: "radial-gradient(160px 120px at var(--gx, 50%) var(--gy, 50%), rgba(255,255,255,0.35), transparent 60%)",
                }}
              />
>>>>>>> d8336f66 (feat: portfolio - Next.js + Tailwind + animations + 3D-ready)
